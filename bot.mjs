...
// ارسال: صبح = آلبوم ۴ عکسی با کپشن بلند؛ بدون متن دیگر.
const CAPTION = `تصاویر دیدنی امروز به انتخاب کوهنامه.
هر روز با نشر تصاویری زیبا با موضوع طبیعت و فرهنگ و ورزش و کوهستان با شما همراه هستیم.
---------------------
@koohnameh`;
